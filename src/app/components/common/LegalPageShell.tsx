    ...
    <>
      <section className="pt-[140px] pb-10 ardoise-bg grain-overlay relative isolate">
        <div className="relative mx-auto max-w-[800px] px-5 sm:px-8">
          ...
          <h1 className="mt-2 font-sans text-[clamp(28px,4vw,48px)] font-normal leading-[1.15] tracking-[-0.02em] text-text-primary">
            {title}
          </h1>
      ...
      <Section tone="dark" containerClassName="max-w-[800px]">
        ...
        <div className="space-y-6 text-[15px] leading-[1.75] text-text-secondary [&_h2]:font-sans [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-text-primary [&_h2]:mt-8 [&_strong]:text-text-primary [&_a]:text-gold-light [&_a]:underline">
          {children}
        </div>
      </Section>
    </>
