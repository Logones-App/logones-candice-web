      ...
      {intro && (
        <header className="mb-8 flex items-start gap-4">
          ...
          <div>
            ...
            <h3 className="mt-1 font-sans text-[clamp(20px,2.5vw,28px)] font-normal text-text-primary">
      ...
      <div className="grid gap-8 lg:grid-cols-[1.2fr_1fr]">
        ...
        <div className="rounded-2xl bg-bg-surface p-6">
          ...
          <div>
            ...
            <p className="mt-2 font-sans text-[clamp(36px,5vw,56px)] font-semibold leading-none text-text-primary">
          ...
          <div>
            ...
            <p className="mt-2 font-sans text-[clamp(36px,5vw,56px)] font-semibold leading-none text-gold-light">
