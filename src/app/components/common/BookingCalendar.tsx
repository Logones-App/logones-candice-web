    ...
    <div className="space-y-8">
      <header className="flex items-start justify-between gap-4">
        <div>
          ...
          <h2 className="mt-3 font-sans text-2xl font-semibold text-text-primary sm:text-3xl">
          ...
          {days.map((day) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={cn(
                    "font-sans text-xl font-semibold leading-none",
        ...
        {selectedHour !== null ? (
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1.5 font-sans text-lg font-semibold text-text-primary">
