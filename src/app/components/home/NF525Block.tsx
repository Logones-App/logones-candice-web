    ...
    <Section tone="light" size="compact">
      <div className="grid items-center gap-12 lg:grid-cols-2">
        <div>
          ...
          <h3 className="mt-3 font-sans text-[clamp(20px,2.5vw,32px)] font-semibold leading-[1.25] tracking-[-0.015em] text-text-dark">
            ...
            <div className="relative flex h-[180px] w-[180px] items-center justify-center rounded-3xl border-2 border-caisse-accent bg-bg-base">
              <div className="text-center">
                <ShieldCheck
                  ...
                  aria-hidden
                />
                <p className="mt-2 font-sans text-2xl font-bold text-text-primary">
                  NF525
                </p>
