    ...
    >
      ...
      >
        <div>
          ...
          <h1 className="mt-6 max-w-3xl text-balance font-display text-[clamp(36px,5vw,64px)] font-light italic leading-[1.1] tracking-[-0.025em] text-text-primary">
            {title}
          </h1>
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <ButtonPrimary href="/logones/demo" size="lg">
              Demander une démo
              <ArrowRight className="h-4 w-4" aria-hidden />
            </ButtonPrimary>
            <ButtonSecondary href="/logones/tarifs" size="lg">
