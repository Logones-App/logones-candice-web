...
const plans: Plan[] = [
  {
    ...
    cta: { label: "Choisir Starter", href: "/demo?plan=starter" },
  },
  {
    id: "pro",
    name: "Pro",
    ...
    cta: { label: "Choisir Pro", href: "/demo?plan=pro" },
  },
  {
    id: "premium",
    name: "Premium",
    ...
    cta: { label: "Choisir Premium", href: "/demo?plan=premium" },
    highlighted: true,
  },
  {
    id: "multi",
    ...
    cta: { label: "Nous contacter", href: "/demo?plan=multi" },
  },
];
